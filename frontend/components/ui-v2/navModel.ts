  ...
  wb: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'unit-pnl',
          label: 'Разбор фин. отчётов',
          icon: 'finance',
          href: (projectId) => `/app/project/${projectId}/wildberries/finances/unit-pnl`,
          match: (rest) => /^wildberries\/finances\/unit-pnl\/?$/.test(rest),
        },
        {
          id: 'unit-pnl-full',
          label: 'Unit P&L',
          icon: 'finance',
          href: (projectId) => `/app/project/${projectId}/wildberries/finances/unit-pnl-full`,
          match: (rest) => /^wildberries\/finances\/unit-pnl-full\/?$/.test(rest),
        },
        {
          id: 'sales-trends',
...
export function humanizeSegment(segment: string): string {
  const known: Record<string, string> = {
    ...
    finances: 'Финансы',
    reports: 'Отчеты',
    'unit-pnl': 'Разбор финансовых отчётов',
    'unit-pnl-full': 'Unit P&L',
    'sku-pnl': 'SKU PnL',
