                    ...
                    <tr className={styles.expandedRow}>
                      <td colSpan={5}>
                        <div className={styles.detailExpand}>
                          <SppDetail series={series} loading={seriesLoading} />
                        </div>
                      </td>
                    </tr>
                  )}
  ...
  return (
    <div className={styles.eventsList}>
      ...
      <div className={styles.changeGrid}>
        <ChangeCard
          title="СПП и витрина"
          changes={sppAndShowcase}
          emptyText="За период СПП и витринная цена не менялись."
        />
        <ChangeCard
          title="Цена WB"
...
function SppDetail({ series, loading }: DetailProps) {
  if (loading) {
    return (
  ...
  return (
    <div className={styles.detailCard}>
      ...
      <div className={styles.detailStats}>
        ...
        <div>
          <span>Изменений</span>
          <strong>{formatInt(timelineChanges.length)}</strong>
        </div>
      </div>
